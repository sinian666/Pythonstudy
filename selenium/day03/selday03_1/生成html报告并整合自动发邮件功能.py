from  selday03_1.HTMLTestRunner import HTMLTestRunner
...
if __name__ == '__main__':
    ...
    test_dir = 'E:/python2/selday03_1'
    #测试报告保存的位置
    test_report = 'D:\\'
    #pattern是要执行的unittest框架的python文件名
    discover = unittest.defaultTestLoader.discover(test_dir,pattern='reglog.py')
